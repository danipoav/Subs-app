...
export default function Hero2({ ref }: Navbar2Props) {
    return (
        <section ref={ref} className="md:flex scroll-mt-16 w-full max-w-6xl mx-auto text-left py-20 pb-2 gap-10">
            <div className=" ">
                <h1 className="text-2xl md:text-4xl font-bold text-center">Subscription Management </h1>
                <p className="mt-4 px-2 md:px-0 text-[13px] md:text-xl max-w-2xl text-justify mb-10 md:mb-0" style={{ color: "#8a8f98" }}>
            ...
            <div>
                <h1 className="text-2xl md:text-4xl font-bold  text-center">Why This Project?</h1>
                <p className="mt-4 px-2 md:px-0 text-[13px] md:text-xl max-w-2xl text-justify" style={{ color: "#8a8f98" }}>
