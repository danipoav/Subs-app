    ...
    return (
        <section ref={ref} className="md:flex scroll-mt-16 w-full max-w-6xl mx-auto text-left py-20 pb-2 gap-10">
            <div className=" ">
                ...
                <p className="mt-4 md:text-xl max-w-2xl text-justify mb-10 md:mb-0" style={{ color: "#8a8f98" }}>
            ...
            <div>
                ...
                <p className="mt-4  md:text-xl max-w-2xl text-justify" style={{ color: "#8a8f98" }}>
